...
- [x] 7. Добавить зависимости и обновить документацию
...
- [x] 8. Интеграционное тестирование
  - [x] 8.1 Написать интеграционный тест полного потока
  ...
  - [x] 8.2 Написать интеграционный тест обработки ошибок
    - Тест обработки ошибки недоступного окна
  ...
  - [x] 8.3 Написать property тест для неблокирующего извлечения иконок
    - **Property 11: Неблокирующее извлечение иконок**
    - **Validates: Requirements 8.2**

- [x] 9. Финальный checkpoint - Полное тестирование
