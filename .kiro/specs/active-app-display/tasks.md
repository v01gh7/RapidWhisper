...
- [ ] 3. Реализовать WindowsWindowMonitor
  ...
  - [~] 3.6 Написать property тест для обработки ошибок
    - **Property 2: Обработка ошибок извлечения иконки**
    - **Validates: Requirements 2.5**
  
  - [~] 3.7 Написать property тест для частоты опроса
    - **Property 10: Частота опроса активного окна**
    - **Validates: Requirements 8.1**
  
  - [~] 3.8 Написать property тест для кэширования
    - **Property 12: Кэширование иконок с управлением размером**
    - **Validates: Requirements 8.3, 8.4**
  
  - [~] 3.9 Написать property тест для логирования ошибок
...
- [ ] 5. Создать UI компонент InfoPanelWidget
  - [~] 5.1 Реализовать InfoPanelWidget в ui/info_panel_widget.py
  ...
  - [~] 5.2 Реализовать стилизацию InfoPanelWidget
  ...
  - [~] 5.3 Реализовать обновление информации о приложении
  ...
  - [~] 5.4 Реализовать обновление горячих клавиш
  ...
  - [~] 5.5 Написать unit тесты для InfoPanelWidget
  ...
  - [~] 5.6 Написать property тест для усечения названий
    - **Property 1: Усечение длинных названий приложений**
    - **Validates: Requirements 1.4**
  
  - [~] 5.7 Написать property тест для отображения горячих клавиш
    - **Property 3: Отображение горячей клавиши из конфигурации**
    - **Validates: Requirements 3.2**
  
  - [~] 5.8 Написать property тест для масштабирования иконок
