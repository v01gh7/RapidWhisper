...
RapidWhisper - это настольное приложение на Python для транскрипции речи в текст в реальном времени, использующее Zhipu GLM API. Приложение реализует минималистичный плавающий интерфейс в стиле SuperWhisper с анимированной визуализацией звуковой волны, автоматическим определением тишины и мгновенным копированием результата в буфер обмена.
