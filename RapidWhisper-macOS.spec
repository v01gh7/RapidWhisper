...
# RapidWhisper PyInstaller Configuration - macOS
# 
# Настройки сохраняются в ~/Library/Application Support/RapidWhisper/
#
# Включается в сборку:
...
#
# Результат: Исполняемый файл для macOS
...
exe = EXE(
    ...
    argv_emulation=True,  # Важно для macOS
    target_arch=None,
    codesign_identity=None,
    entitlements_file=None,
    icon=None,  # Иконка будет добавлена в .app bundle
)
